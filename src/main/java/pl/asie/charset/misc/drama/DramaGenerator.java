...
package pl.asie.charset.misc.drama;
...
public class DramaGenerator {
	...
	static {
		COMBINATIONS.put("people" , Arrays.asList(new String[]{"Player", "jadedcat", "Alblaka", "GregoriousT", "Eloraam", "MrTJP", "mezz",
		...
		COMBINATIONS.put("sites" , Arrays.asList(new String[]{"FTB Forums", "MCF", "Reddit", "4chan", "Technic Forums", "IC2 Forums", "GitHub", "BitBucket", "IRC",
				"ForgeCraft", "Patreon", "BTW Forums", "GregTech thread", "Google+", "Twitch", "Beam", "Twitter"}));
		COMBINATIONS.put("things" , Arrays.asList(new String[]{"ForgeCraft", "Simply Jetpacks", "RedPower 2", "ModLoader", "RedLogic", "Forge MultiPart", "Project: Red",
		...
		COMBINATIONS.put("packs" , Arrays.asList(new String[]{"Feed The Beast", "the ForgeCraft pack", "FTB Monster", "FTB Unstable", "Agrarian Skies", "Direwolf20 Pack",
		...
		COMBINATIONS.put("function" , Arrays.asList(new String[]{"MJ support", "RF support", "EU support", "FMP compatibility", "MCMP compatiblity", "quarries", "automatic mining", "GregTech balance",
		...
		COMBINATIONS.put("adj" , Arrays.asList(new String[]{"bad", "wrong", "illegal", "horrible", "nasty", "not on ForgeCraft",
		...
		COMBINATIONS.put("badsoft" , Arrays.asList(new String[]{"malware", "spyware", "adware", "DRM", "viruses", "trojans", "keyloggers",
				"stolen code", "easter eggs", "potential login stealers", "adf.ly links", "bad code", "stolen assets", "malicious code", "secret backdoors"}));
		COMBINATIONS.put("drama" , Arrays.asList(new String[]{"bugs", "crashes", "drama", "lots of drama", "imbalance", "pain and suffering", "piracy", "bees", "adf.ly"}));
		COMBINATIONS.put("crash" , Arrays.asList(new String[]{"crash", "explode", "break", "lag", "blow up", "corrupt chunks", "corrupt worlds", "rain hellfish", "spawn bees"}));
		COMBINATIONS.put("ban" , Arrays.asList(new String[]{"ban", "kick", "put a pumpkin of shame on", "add items mocking", "blacklist", "whitelist",
				"give admin rights to", "shame", "destroy"}));
		COMBINATIONS.put("code" , Arrays.asList(new String[]{"code", "assets", "ideas", "concepts", "a single function", "5 lines of code", "a class",
				"a few files", "a ZIP file", "Gradle buildscripts", "a GitHub repository"}));
		COMBINATIONS.put("worse" , Arrays.asList(new String[]{"worse", "better", "faster", "slower", "more stable", "less buggy"}));
		COMBINATIONS.put("ac1" , Arrays.asList(new String[]{"sue", "destroy the life of", "flame", "cause drama about", "complain about", "kick"}));
		COMBINATIONS.put("price" , Arrays.asList(new String[]{"150$", "200$", "250$", "300$", "350$", "400$", "450$", "500$", "600$", "650$", "700$"}));
		COMBINATIONS.put("activates" , Arrays.asList(new String[]{"activates", "works", "functions", "breaks"}));
