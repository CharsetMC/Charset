        ...
        for (EnumFacing facing : EnumFacing.VALUES) {
            ...
            if (!isOpaque() && connections[facing.ordinal()]) {
                ...
                if (connections[neighbors[2].ordinal()]) {
                    ...
                    quads.add(faceBakery.makeBakedQuad(from, to, -1, sprite, EnumFacing.DOWN, ROTATIONS[facing.ordinal()], true));
                    quads.add(faceBakery.makeBakedQuad(from, to, -1, sprite, EnumFacing.UP, ROTATIONS[facing.ordinal()], true));
                }
